...
function MuiImageList() {
    return (
        <Stack spacing={3} >
            <ImageList sx={{ height: 500, width: 600 }} cols={3} rowHeight={165}>
            ...
            <ImageList variant='woven' sx={{ height: 500, width: 600 }} cols={3} gap={8}>
            ...
            <Box sx={{ height: 300, width: 600, overflowY: "scroll" }}>
